...
!macro customInstall
  ...
  Pop $0
  IfErrors 0 +2
  MessageBox MB_OK|MB_ICONEXCLAMATION "Error setting up installation directories or resetting data. Please ensure you have enough disk space and write permissions."
!macroend
