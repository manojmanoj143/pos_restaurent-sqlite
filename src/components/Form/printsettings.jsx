    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <FaArrowLeft style={{ fontSize: '48px', marginBottom: '20px', color: '#3498db' }} />
          <p>Loading print settings...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <FaArrowLeft style={{ fontSize: '48px', marginBottom: '20px', color: '#e74c3c' }} />
          <p>Error: {error}</p>
        </div>
      </div>
    );
